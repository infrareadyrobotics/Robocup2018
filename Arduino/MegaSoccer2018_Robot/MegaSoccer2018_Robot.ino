...
void loop() {
  ...
  if (ballDist <= 40) bypassState = attack;
...
void Chaseball() {
  ...
  Serial.print(",\t");
  Serial.print((defend == bypassState || (defend == robotType && !canSeeBall)));// //
  Serial.print(",\t");
  if (goalDist <= goalLocation - 15 && (defend == bypassState || (defend == robotType && !canSeeBall))) {// && canSeeBall
    if (goalX < 165 && goalX > 155) Direction = 6;
    else if (goalX > 160) Direction = 4;
    else if (goalX < 160) Direction = 5;
  }
  else if ((goalDist >= goalLocation - 15 && goalDist <= goalLocation + 15) && (defend == bypassState || (defend == robotType && !canSeeBall))) Direction = 0;
  else if (goalDist >= goalLocation + 20 && (defend == bypassState || (defend == robotType && !canSeeBall))) Direction = 1;
  else if (ballX < 195 && ballX > 125) {//
    Direction = 1;
    ...
    if (canSeeBall == false) Direction = 0;
  }
